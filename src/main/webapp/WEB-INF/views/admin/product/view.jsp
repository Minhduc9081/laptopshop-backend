                        ...
                        <div class="product-image-section">
                            <div class="product-image-container">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <img src="/resources/images/product/${product.imagePath}"
                                             alt="Product Image"
                                             class="product-image"
                                             onerror="this.onerror=null; this.src='/resources/images/default-product.png';" />
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        ...
                        <div class="product-info-container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value price-value">$${product.price}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">${product.sold} units</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-value">${product.detailDescription}</div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">${product.manufacture}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info-item">
