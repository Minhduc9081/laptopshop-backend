                                            ...
                                            <div class="image-preview-container">
                                                <c:choose>
                                                    <c:when test="${not empty product.imagePath}">
                                                        <img id="currentImage"
                                                             src="/resources/images/product/${product.imagePath}"
                                                             alt="Current Profile"
                                                             class="image-preview">
                                                    </c:when>
                                                    <c:otherwise>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="detailDescription" value="${product.detailDescription}"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="shortDescription" value="${product.shortDescription}"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="quantity" value="${product.quantity}"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="sold" value="${product.sold}"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="manufacture" value="${product.manufacture}"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="target" value="${product.target}"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
